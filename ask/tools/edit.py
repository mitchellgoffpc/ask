...
class EditTool(Tool):
    ...
    def replace(self, file_path: Path, content: str, old_string: str, new_string: str, replace_all: bool, prefix: str = "") -> str:
    ...
    def check(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        new_content = self.replace(file_path, content, args["old_string"], args["new_string"], replace_all)
